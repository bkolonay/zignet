...
it('renders when not grouped', () => {
  const component = <LastRunTimeLabel grouped={false} suiteEndTime={'2019-04-24T01:00:00'} />;
  ReactDOM.render(component, document.createElement('div'));
});

it('renders when grouped', () => {
  const component = <LastRunTimeLabel grouped={true} suiteEndTime={'2019-04-24T01:00:00'} />;
  ReactDOM.render(component, document.createElement('div'));
});
