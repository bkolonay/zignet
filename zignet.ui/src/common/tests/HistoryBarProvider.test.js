...
xit('gets a failure duration with a start and end time', () => {
...
xit('gets a failure with a duration of 1 second', () => {
  let now = moment("2018-05-07T01:00:00-07:00"); // 5/7/2018 1am
  var failureStart = moment("2018-05-06T03:00:00-07:00"); // 5/6/2018 3am
...
xit('gets a failure duration with no end time', () => {
...
xit('gets a failure duration with end time 1 second before now', () => {
...
xit('gets a failure duration with a start time before 24 hours ago and end time within 24 hours', () => {
  let now = moment("2018-05-07T01:00:00-07:00"); // 5/7/2018 1am
...
xit('gets a failure duration with a start time before 24 hours ago and no end time', () => {
  let now = moment("2018-05-07T01:00:00-07:00"); // 5/7/2018 1am
...
xit('gets a failure duration with a start time 1 second before 24 hours ago and end time 1 second within 24 hours', () => {
  let now = moment("2018-05-07T01:00:00-07:00"); // 5/7/2018 1am
...
// getDivTitle()
xit('get title when failure has a start and end time', () => {
  var failureStart = moment("2018-05-06T03:00:00-07:00"); // 5/6/2018 3am
  var failureEnd = moment("2018-05-06T04:00:00-07:00"); // 5/6/2018 4am
  let testFailureDuration = {
    FailureStart: failureStart.utc().format(),
...
xit('get title when dates have double digits', () => {
...
xit('get title when end date is null', () => {
  var failureStart = moment("2018-05-06T03:00:00-07:00"); // 5/6/2018 3am
  let testFailureDuration = {
    FailureStart: failureStart.utc().format(),
    FailureEnd: null
...
xit('does not throw when dates empty', () => {
  let testFailureDuration = {
    FailureStart: null,
    FailureEnd: null
  };
