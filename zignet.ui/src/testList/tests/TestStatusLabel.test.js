...
it('renders when has failing from date', () => {
  const component = <TestStatusLabel failingFromDate={'2019-04-24T01:00:00'} />;
  ReactDOM.render(component,document.createElement('div'));
});

it('renders when does not have failing from date', () => {
  const component = <TestStatusLabel failingFromDate={undefined} passingFromDate={'2019-05-05T01:00:00'} />;
  ReactDOM.render(component,document.createElement('div'));
});
